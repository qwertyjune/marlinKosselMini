...
// Calibration by June 151004
  // these are the offsets to the probe relative to the extruder tip (Hotend - Probe)
  #define X_PROBE_OFFSET_FROM_EXTRUDER 1.60   //MR: Changed from 3.5
  #define Y_PROBE_OFFSET_FROM_EXTRUDER 13.20    //MR: Changed from 17
  ...
  //#define X_PROBE_OFFSET_FROM_EXTRUDER -1.60
  //#define Y_PROBE_OFFSET_FROM_EXTRUDER -13.20
...
//#define MANUAL_Z_HOME_POS 280.00  // CHANGE HEIGHT OF PRINTER HERE! For delta: Distance between nozzle and print surface after homing.
//Calibation by June 20151004
#define MANUAL_Z_HOME_POS 267.2  // CHANGE HEIGHT OF PRINTER HERE! For delta: Distance between nozzle and print surface after homing.
